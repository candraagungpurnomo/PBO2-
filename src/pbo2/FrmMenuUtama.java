...
public class FrmMenuUtama extends javax.swing.JFrame {
    ...
    private void tampilIcon(){
        mnuFile.setIcon(new ImageIcon("./assets/File_64x64.png"));
        mnuMaster.setIcon(new ImageIcon("./assets/Master_64x64.png"));
        mnuTransaksi.setIcon(new ImageIcon("./assets/Shopping_64x64.png"));
        mnuLaporan.setIcon(new ImageIcon("./assets/Report_64x64.png"));
        mnuAbout.setIcon(new ImageIcon("./assets/About_64x64.png"));
        mnuKeluar.setIcon(new ImageIcon("./assets/Keluar_16x16.png"));
        mnuKonsumen.setIcon(new ImageIcon("./assets/Customer_16x16.png"));
        mnuSupplier.setIcon(new ImageIcon("./assets/Supplier_16x16.png"));
        mnuBarang.setIcon(new ImageIcon("./assets/Barang_16x16.png"));
        mnuPenjualan.setIcon(new ImageIcon("./assets/Penjualan_16x16.png"));
        mnuPembelian.setIcon(new ImageIcon("./assets/Pembelian_16x16.png"));
        mnuReturPenjualan.setIcon(new ImageIcon("./assets/ReturPenjualan_16x16.png"));
        mnuReturPembelian.setIcon(new ImageIcon("./assets/ReturPembelian_16x16.png"));
        mnuLapKonsumen.setIcon(new ImageIcon("./assets/LapKonsumen_16x16.png"));
        mnuLapSupplier.setIcon(new ImageIcon("./assets/LapSupplier_16x16.png"));
        mnuLapBarang.setIcon(new ImageIcon("./assets/LapBarang_16x16.png"));
        mnuLapPenjualan.setIcon(new ImageIcon("./assets/LapPenjualan_16x16.png"));
        mnuLapPembelian.setIcon(new ImageIcon("./assets/LapPembelian_16x16.png"));
        mnuLapReturPenjualan.setIcon(new ImageIcon("./assets/LapReturPenjualan_16x16.png"));
        mnuLapReturPembelian.setIcon(new ImageIcon("./assets/LapReturPembelian_16x16.png"));
    }
    ...
    private void initComponents() {
        ...
        mnuKeluar.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_E, java.awt.event.InputEvent.CTRL_MASK));
